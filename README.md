...
This repository builds the backend for an e-commerce application using Spring Boot. The API includes endpoints for:
...
```bash
git clone /https://github.com/dedywong31/shopping-cart.git
cd shopping-cart
```
...
Check out the Mosh's full course here: [Spring Boot: Mastering REST API Development](https://codewithmosh.com/p/spring-boot-building-apis)
